...
COMMIT;
INSERT INTO FubaoUser VALUES ('손인천', '남', TO_DATE('1994/07/14', 'YYYY/MM/DD'), '010-1111-1111', '손', 'S1111', '1111', TO_DATE('2023/09/01', 'YYYY/MM/DD'), 10);
INSERT INTO FubaoUser VALUES ('양원모', '남', TO_DATE('1991/03/19', 'YYYY/MM/DD'), '010-2222-2222', '양', 'Y2222', '2222', TO_DATE('2023/09/02', 'YYYY/MM/DD'), 10);
INSERT INTO FubaoUser VALUES ('김현빈', '남', TO_DATE('2000/02/02', 'YYYY/MM/DD'), '010-3333-3333', '김', 'K3333', '3333', TO_DATE('2023/09/03', 'YYYY/MM/DD'), 10);
INSERT INTO FubaoUser VALUES ('정벼리', '남', TO_DATE('1994/04/07', 'YYYY/MM/DD'), '010-4444-4444', '정', 'J4444', '4444', TO_DATE('2023/09/04', 'YYYY/MM/DD'), 10);
INSERT INTO FubaoUser VALUES ('이재성', '남', TO_DATE('1994/07/06', 'YYYY/MM/DD'), '010-5555-5555', '이', 'L5555', '5555', TO_DATE('2023/09/05', 'YYYY/MM/DD'), 10);
INSERT INTO FubaoUser VALUES ('이재원', '남', TO_DATE('1996/12/03', 'YYYY/MM/DD'), '010-6666-6666', '리', 'L6666', '6666', TO_DATE('2023/09/03', 'YYYY/MM/DD'), 10);

SELECT table_name FROM user_tables;
CREATE TABLE LIKE_DIS (
S_NUMBER NUMBER,
S_LIKE CHAR(1) DEFAULT 0,
S_DIS  CHAR(1) DEFAULT 0,
NICK VARCHAR2(50)
);

--인덱스란 검색 성능을 개선하기 위해 별도의 색인 테이블에 등록 후 관리

SELECT * FROM LIKE_DIS;

SELECT *
FROM LIKE_DIS
where S_NUMBER=1 AND NICK='s1111';

SELECT s.TITLE,COUNT(LL.S_LIKE),COUNT(LL.S_DIS)
FROM  STREAMING S,LIKE_DIS LL
where S.S_NUMBER=LL.S_NUMBER AND  S.TITLE = '인간중독'
GROUP BY S.TITLE;
COMMIT;

--VIEW? 하나 이상의 테이블을 조회하는 SELECT 문을 저장하는 객체
--복잡한 테이블은 단순화하기 위한 목적,보안상 목적
--뷰를 생성하기 위해서는 권한이 필요 DELETE
CREATE VIEW VE_EMP20
as(SELECT empno,ename,JOB,DEPTNO
FROM EMP
where DEPTNO =20);
GRANT CREATE SESSION TO VE_EMP20;