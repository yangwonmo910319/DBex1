...
-- 영화 검색--
SELECT s.TITLE,COUNT(LL.S_LIKE),COUNT(LL.S_DIS),s.CAST,s.RUNNING_TIME
FROM  STREAMING S,LIKE_DIS LL
where S.S_NUMBER=LL.S_NUMBER AND  S.TITLE = '인간중독'
GROUP BY S.TITLE,S.CAST,s.RUNNING_TIME;
...
SELECT * FROM REVIEW WHERE  S_NUMBER =2;
COMMIT;
CREATE TABLE ADUSER (
  COMPANY VARCHAR2(50),
  BANNER VARCHAR2(300),
...
UPDATE FUBAOUSER SET TOKEN = 1 WHERE ID = 'y2222!!';



INSERT INTO ADUSER (COMPANY,BANNER,START_AD,END_AD,VIEW_PRICE,COMPANY_MONEY)VALUES('x','222x',TO_DATE('2023/09/20', 'YYYY/MM/DD'), TO_DATE('2023/10/20', 'YYYY/MM/DD'),2000,1000);
INSERT INTO ADUSER (COMPANY,BANNER,START_AD,END_AD,VIEW_PRICE,COMPANY_MONEY)VALUES('x','222x','2023/09/20', '2023/10/20',2000,1000);
